...
<section class="cwfw-wrap" aria-labelledby="cwfw-heading">
	...
	<form method="post" action="<?php echo esc_url( $return_url ); ?>" class="cwfw-form" id="cwfw-form" novalidate>
		<input type="hidden" name="cwfw_nonce" value="<?php echo esc_attr( $nonce ); ?>">
